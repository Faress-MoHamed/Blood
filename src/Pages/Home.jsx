	...
	return (
		<>
			...
			<main className="pt-[60px]">
				<section className="hero relative flex justify-center items-center bg-[url(./donation-8937.jpg)] bg-no-repeat after:absolute after:left-0 after:top-0 after:w-full after:h-full after:bg-black/35 h-[92.6vh] bg-cover">
